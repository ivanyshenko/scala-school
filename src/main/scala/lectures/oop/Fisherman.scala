...
class PartO extends PartA with PartY with PartCH with PartD with PartK {
  override def str = super[PartY].str + super[PartD].str + "O" + super[PartCH].str + super[PartK].str + super[PartA].str
}
